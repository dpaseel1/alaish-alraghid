 ...
 *  يشمل التحويل الفاصلة الإنجليزية (,) والفاصلة العربية (،) والفاصلة العشرية العربية (٫) التي تُنتجها لوحات المفاتيح
 *  ولوحات الأرقام العربية على الجوال بدل النقطة العادية */
