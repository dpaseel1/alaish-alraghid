  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-xl font-bold text-slate-800">الأرشيف والشهادات</h1>
      ...
      {!halaqa && (
        <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center text-slate-400 print:hidden">
          {user.role === "TEACHER"
      ...
      {halaqa && !selectedStudent && (
        <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-sm print:hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-y-2 text-sm mb-6">
              ...
              <p>
                <span className="text-slate-400">المعلمة: </span>
                {selectedStudent.halaqa.teacher?.name ?? "—"}
              </p>
              <p>
                <span className="text-slate-400">إجمالي الأوجه المحفوظة: </span>
                <span className="font-semibold text-brand">
                  {selectedStudent.memorizedPagesTotal}
                </span>
              </p>
              <p>
                <span className="text-slate-400">النصاب الحالي: </span>
                {selectedStudent.currentQuota ?? "—"}
              </p>
            </div>

            <h3 className="font-semibold text-slate-800 mb-2">درجات الاختبارات</h3>
            ...
            <h3 className="font-semibold text-slate-800 mb-2">سجل التسميع اليومي</h3>
