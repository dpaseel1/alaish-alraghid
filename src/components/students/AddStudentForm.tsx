    ...
    >
      ...
      <div>
        ...
        <input
          name="name"
          required
          className="rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand focus:border-brand"
      ...
      {state?.error && (
        <span className="text-xs text-red-600 basis-full">{state.error}</span>
      )}
    </form>
  );
}
